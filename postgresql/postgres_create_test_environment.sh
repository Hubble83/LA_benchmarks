...
echo -e "COPY part_$i FROM '$DATA_DIR/$i/part.tbl' WITH DELIMITER AS '|';"
echo -e "COPY region_$i FROM '$DATA_DIR/$i/region.tbl' WITH DELIMITER AS '|';"
echo -e "COPY nation_$i FROM '$DATA_DIR/$i/nation.tbl' WITH DELIMITER AS '|';"
echo -e "COPY supplier_$i FROM '$DATA_DIR/$i/supplier.tbl' WITH DELIMITER AS '|';"
echo -e "COPY partsupp_$i FROM '$DATA_DIR/$i/partsupp.tbl' WITH DELIMITER AS '|';"
echo -e "COPY customer_$i FROM '$DATA_DIR/$i/customer.tbl' WITH DELIMITER AS '|';"
echo -e "COPY orders_$i FROM '$DATA_DIR/$i/orders.tbl' WITH DELIMITER AS '|';"
echo -e "COPY lineitem_$i FROM '$DATA_DIR/$i/lineitem.tbl' WITH DELIMITER AS '|';"
